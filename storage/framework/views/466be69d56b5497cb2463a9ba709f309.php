            ...
            <form onsubmit="submitForm(event)" id="fee-form">
                ...
                <div class="md-grid" style="margin-bottom:14px">
                        ...
                        <select id="f-course" class="f-input" onchange="courseSelected()">
                            ...
                            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($c->id); ?>"
                                    data-units="<?php echo e($c->total_units); ?>"
                                    data-type="<?php echo e($c->unit_type); ?>">
                    ...
                    <div>
                        ...
                        <input type="number" id="f-year" class="f-input" min="2000" max="2099" value="<?php echo e(date('Y')); ?>">
...
dt = $('#fees-table').DataTable({
    ...
    ajax: {
        url: '<?php echo e(route("writer.master.fees.datatable")); ?>',
...
async function submitForm(e) {
    ...
    const res  = await fetch('<?php echo e(route("writer.master.fees.store")); ?>', {
        method: 'POST',
...
async function confirmDelete() {
    const res  = await fetch(`<?php echo e(url('writer/master/fees')); ?>/${deleteId}`, {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ramaw\Desktop\CollegeProject\IntelliCampus ERP\resources\views/writer/master/fees/index.blade.php ENDPATH**/ ?>