...
<div class="filter-bar">
    <select id="filter-dept" class="f-select" onchange="dt.ajax.reload()">
...
const dt = $('#courses-table').DataTable({
...
async function submitForm(e) {
    ...
    showToast(data.message, 'success'); closeModal(); dt.ajax.reload(null, false);
}
...
async function confirmDelete() {
    ...
    dt.ajax.reload(null,false); closeDelModal();
}
