...
<div class="relative" x-data="studentAttendance()" x-init="initPage()">
    ...
    <div class="sa-stats-row">
        ...
        <div class="sa-stat-card sa-stat-hero sa-fade-in" style="--delay:.1s">
            ...
            <div class="sa-stat-body">
                ...
                <span class="sa-stat-value sa-counter" data-target="<?php echo e($summary['overall']['percentage']); ?>">0</span>
            </div>
            <span class="sa-stat-unit">%</span>
            <div class="sa-stat-bar-track">
                <div class="sa-stat-bar sa-bar-accent" data-width="<?php echo e($summary['overall']['percentage']); ?>"></div>
            </div>
        </div>
        ...
        <div class="sa-stat-card sa-fade-in" style="--delay:.18s">
            ...
            <div class="sa-stat-body">
                ...
                <span class="sa-stat-value sa-counter" data-target="<?php echo e($summary['overall']['present']); ?>">0</span>
            </div>
        ...
        <div class="sa-stat-card sa-fade-in" style="--delay:.26s">
            ...
            <div class="sa-stat-body">
                ...
                <span class="sa-stat-value sa-counter" data-target="<?php echo e($summary['overall']['absent']); ?>">0</span>
            </div>
            <span class="sa-stat-sessions">sessions</span>
        </div>
        ...
        <div class="sa-stat-card sa-fade-in" style="--delay:.34s">
            ...
            <div class="sa-stat-body">
                ...
                <span class="sa-stat-value sa-counter" data-target="<?php echo e($summary['overall']['total']); ?>">0</span>
            </div>
            <span class="sa-stat-sessions">sessions</span>
        </div>
    </div>
            ...
            <div x-show="!marked" class="sa-active-state">
                ...
                <div class="sa-active-bottom">
                    <div class="sa-timer-block"
                         x-data="timer(<?php echo e(\Carbon\Carbon::parse($activeSession->start_time)->addMinutes($activeSession->attendance_window_minutes)->timestamp); ?>)">
                    ...
                    <button @click="markAttendance(<?php echo e($activeSession->id); ?>)"
                            :disabled="loading"
                            class="sa-btn-cta"
    ...
    <div class="sa-section sa-fade-in" style="--delay:.5s">
        <div class="sa-section-head">
            ...
            <div class="sa-pill"><?php echo e(count($summary['subjects'])); ?> Subjects</div>
        </div>

        <div class="sa-subj-grid">
            <?php $__currentLoopData = $summary['subjects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
            <div class="sa-subj-card sa-fade-in" style="--delay:<?php echo e(.55 + $idx * .07); ?>s">
                <div class="sa-subj-top">
                    <div class="sa-subj-icon" style="background:<?php echo e($accentBg); ?>">
                        <span class="material-symbols-outlined" style="font-size:20px;color:<?php echo e($accent); ?>">menu_book</span>
                    </div>
                    <div class="sa-subj-info">
                        <h4 class="sa-subj-name"><?php echo e($subject['subject']); ?></h4>
                        <span class="sa-subj-sessions"><?php echo e($subject['present']); ?> / <?php echo e($subject['total']); ?> sessions</span>
                    </div>
                    <div class="sa-subj-right">
                        <span class="sa-subj-pct" style="color:<?php echo e($accent); ?>"><?php echo e($pct); ?>%</span>
                        <span class="sa-subj-tag" style="background:<?php echo e($accentBg); ?>;color:<?php echo e($accent); ?>">
                            <span class="material-symbols-outlined" style="font-size:12px"><?php echo e($icon); ?></span>
                            <?php echo e($tag); ?>
                ...
                <div class="sa-subj-bar-track">
                    <div class="sa-subj-bar" style="background:<?php echo e($accent); ?>" data-width="<?php echo e($pct); ?>">
                        <div class="sa-bar-shine"></div>
                    </div>
                </div>
                <?php if($subject['total'] - $subject['present'] > 0): ?>
                    <div class="sa-subj-note">
                        <span class="material-symbols-outlined" style="font-size:13px;color:#EF4444">info</span>
                        <?php echo e($subject['total'] - $subject['present']); ?> absent
                        <?php if($pct < 75): ?>
                            — <strong style="color:#EF4444">Need <?php echo e(max(0, ceil(0.75 * $subject['total'] - $subject['present']))); ?> more to reach 75%</strong>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('studentAttendance', () => ({
        ...
        async submitAttendance(sessionId, lat, lng) {
            try {
                const res = await fetch('<?php echo e(route("student.attendance.mark")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ramaw\Desktop\CollegeProject\IntelliCampus ERP\resources\views/student/attendance/index.blade.php ENDPATH**/ ?>