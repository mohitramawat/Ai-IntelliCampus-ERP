...
<?php if(session('success')): ?>
    <div class="card bg-status-successs/20 border-status-success/30 mb-8 flex items-center gap-3 p-4">
        ...
        <p class="text-sm font-semibold text-status-success"><?php echo e(session('success')); ?></p>
    </div>
<?php endif; ?>
...
<?php if(session('error')): ?>
    <div class="card bg-status-dangers/20 border-status-danger/30 mb-8 flex items-center gap-3 p-4">
        ...
        <p class="text-sm font-semibold text-status-danger"><?php echo e(session('error')); ?></p>
    </div>
<?php endif; ?>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="card h-fit">
        ...
        <form action="<?php echo e(route('accounts.fines.apply')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="deadline_date" value="<?php echo e(date('Y-m-d')); ?>" class="input" required>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ramaw\Desktop\CollegeProject\IntelliCampus ERP\resources\views/accounts/fees/fines.blade.php ENDPATH**/ ?>