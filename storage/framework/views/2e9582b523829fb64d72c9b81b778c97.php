    ...
    <div class="min-h-screen flex flex-col justify-center items-center">
        <div class="max-w-4xl w-full text-center">
            ...
            <footer class="mt-12 text-gray-400 text-sm">
                &copy; <?php echo e(date('Y')); ?> IntelliCampus. All rights reserved.
            </footer>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\ramaw\Desktop\CollegeProject\IntelliCampus ERP\resources\views\home.blade.php ENDPATH**/ ?>