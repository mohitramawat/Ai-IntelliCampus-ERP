...
<div class="relative bg-gradient-to-r from-pink-500 to-rose-400 rounded-2xl p-6 mb-6 overflow-hidden shadow-[0_4px_14px_rgba(236,72,153,0.35)]">
    ...
    <div class="relative z-10">
        ...
        <p class="text-white/70 text-sm mt-1">{{ now()->format('l, d F Y') }} · Writer / Data Entry</p>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="card">
        ...
        <div class="space-y-2">
            <a href="{{ route('writer.students.create') }}" class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-muted transition-colors group">
            ...
            <a href="{{ route('writer.students.index') }}" class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-muted transition-colors group">
                <div class="w-9 h-9 rounded-xl bg-brand-muted flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
            ...
            <a href="{{ route('writer.students.pending-documents') }}" class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-muted transition-colors group">
                <div class="w-9 h-9 rounded-xl bg-brand-muted flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
    ...
    <div class="card">
        ...
        <div class="space-y-2">
            <a href="{{ route('writer.master.departments.index') }}" class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-muted transition-colors group">
            ...
            <a href="{{ route('writer.master.courses.index') }}" class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-muted transition-colors group">
            ...
            <a href="{{ route('writer.master.batches.index') }}" class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-muted transition-colors group">
                <div class="w-9 h-9 rounded-xl bg-brand-muted flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
            ...
            <a href="{{ route('writer.master.subjects.index') }}" class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-muted transition-colors group">
            ...
            <a href="{{ route('writer.master.fees.index') }}" class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-muted transition-colors group">
