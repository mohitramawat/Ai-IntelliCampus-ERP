...
<div class="py-12 px-6">
    <div class="pf-card" x-data="profileManager()">
        ...
        <div class="pf-avatar-wrapper">
            <img :src="previewUrl || '{{ $student->profile_picture ? asset('storage/'.$student->profile_picture) : 'https://ui-avatars.com/api/?name='.urlencode(auth()->user()->name).'&size=160&background=EEF2FF&color=6366F1' }}'" 
...
document.addEventListener('alpine:init', () => {
    Alpine.data('profileManager', () => ({
        ...
        errorMsg: '',
        successMsg: '',
        hasDescriptor: {{ $student->face_descriptor ? 'true' : 'false' }},
        modelsLoaded: false,
