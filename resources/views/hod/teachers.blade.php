...
<div class="bg-gradient-to-r from-violet-50 to-fuchsia-50 border border-violet-100 rounded-2xl p-4 mb-6 flex items-start gap-4">
    ...
    <div>
        ...
        <p class="text-xs text-violet-600/80 font-medium">
            You are viewing all teachers in the <strong>{{ $dept->name }}</strong> department. If you need to add, edit, or remove faculty members, please contact the Data Entry / Writer department.
        </p>
    </div>
</div>
...
$('#teachers-table').DataTable({
    ...
    ajax: '{{ route("hod.teachers.datatable") }}',
    columns: [
